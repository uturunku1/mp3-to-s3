        ...
        if (err) {
            ...
            ytdl.getInfo(videoUrl, { quality: self.youtubeVideoQuality }, function(err, info) {
                ...
                stream.on("response", function(httpResponse) {
                    ...
                    //Start encoding
                    //'pipe' event is emitted when the stream.pipe() method is called on a readable stream,, adding this writable(str) to destination
                    var proc = new ffmpeg({
                        source: stream.pipe(str) //url or path to mp3 S3
                    })
